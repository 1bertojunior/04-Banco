...
# Form implementation generated from reading ui file 'Historic.ui'
#
...
"}")
        ...
        self.label_despesa_2 = QtWidgets.QLabel(self.frame_card)
        self.label_despesa_2.setGeometry(QtCore.QRect(10, 20, 341, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.label_despesa_2.setFont(font)
        self.label_despesa_2.setStyleSheet("color: rgb(115, 210, 22);")
        self.label_despesa_2.setObjectName("label_despesa_2")
        self.label_despesa_3 = QtWidgets.QLabel(self.frame_card)
        self.label_despesa_3.setGeometry(QtCore.QRect(10, 60, 341, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.label_despesa_3.setFont(font)
        self.label_despesa_3.setStyleSheet("color: rgb(204, 0, 0);")
        self.label_despesa_3.setObjectName("label_despesa_3")
        self.label_despesa_4 = QtWidgets.QLabel(self.frame_card)
        self.label_despesa_4.setGeometry(QtCore.QRect(10, 100, 341, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.label_despesa_4.setFont(font)
        self.label_despesa_4.setStyleSheet("color: rgb(204, 0, 0);")
        self.label_despesa_4.setObjectName("label_despesa_4")
        self.label_despesa_5 = QtWidgets.QLabel(self.frame_card)
        self.label_despesa_5.setGeometry(QtCore.QRect(10, 140, 341, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.label_despesa_5.setFont(font)
        self.label_despesa_5.setStyleSheet("color: rgb(115, 210, 22);")
        self.label_despesa_5.setObjectName("label_despesa_5")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_despesa_2.setText(_translate("MainWindow", "+                         R$900,00             DEPOSITO"))
        self.label_despesa_3.setText(_translate("MainWindow", "-                         R$50,00                      321"))
        self.label_despesa_4.setText(_translate("MainWindow", "-                         R$230,00               SAQUE"))
        self.label_despesa_5.setText(_translate("MainWindow", "+                         R$50,00                     321"))
